...
export const highlights = [
  {
    ...
    description:
      "Peace-of-mind craftsmanship backed by state and local credentials.",
  },
  {
    title: "Roof & Plumbing Specialists",
    description:
      "From rooftop to crawlspace, a single team handles the tough jobs.",
  },
  {
...
export const services: Array<{
...
}> = [
  {
    ...
    items: [
      "Full tear-offs and rebuilds",
      "Leak diagnostics & patching",
  ...
  },
  {
    ...
    items: [
      "Fixture installs & repairs",
      "Water heater & softener service",
      "Sump pumps & drainage",
    ],
  },
  {
    ...
    items: [
      ...
      "Siding & gutter replacements",
      "Concrete & deck builds",
    ],
  },
  {
...
export const projectGallery = [
  {
    ...
    description:
      "Modern metal roof retrofit engineered to withstand heavy wind and snow load.",
  },
  {
    ...
    description:
      "Custom tile work, rainfall fixtures, and a spa-level plumbing upgrade.",
  },
  {
    ...
    description:
      "Roof, gutters, and interior rebuild delivered on a rapid disaster timeline.",
  },
];
...
export const processSteps = [
  {
    ...
    detail:
      "We document the project, capture photos, and outline must-haves with you on-site.",
  },
  {
    title: "Transparent Proposal",
    detail:
      "You receive a clear scope, timeline, and upfront pricing—no surprises mid-project.",
  },
  {
    title: "Skilled Execution",
    detail:
      "Licensed pros handle each trade, coordinating every detail and protecting your home.",
  },
  {
    title: "Quality Sign-Off",
    detail:
      "Final walkthrough, detailed cleanup, and warranty documentation for your records.",
  },
];
